...
const OX: SpeciesSpec = {
  ...
  head: [
    ...
    { at: [0, 1.45, 1.23], hw: 0.106, hh: 0.094 },
    { at: [0, 1.392, 1.28], hw: 0.088, hh: 0.076 },
    { at: [0, 1.338, 1.328], hw: 0.072, hh: 0.062 },
  ],
  skull: [0, 1.585, 1.08],
...
const HORSE: SpeciesSpec = {
  ...
  head: [
    ...
    { at: [0, 1.735, 1.32], hw: 0.07, hh: 0.07 },
    { at: [0, 1.668, 1.386], hw: 0.062, hh: 0.058 },
    { at: [0, 1.608, 1.44], hw: 0.055, hh: 0.045 },
  ],
  skull: [0, 1.865, 1.13],
