  ...
  interact: {
    ...
    keys: [
      { t: 0, pose: { ...RELAXED_ARMS } },
      {
        ...
        root: [-0.02, -0.44, 0.1],
        pose: {
          Chest: [22, 6, 0], Spine: [14, 3, 0], Head: [24, 4, 0],
          UpperArmR: [-58, 0, -8], LowerArmR: [-36, 0, 0],
          UpperArmL: [14, 0, 8], LowerArmL: [-24, 0, 0],
      ...
      },
      {
        ...
        root: [-0.02, -0.46, 0.12],
        pose: {
          Chest: [28, 8, 0], Spine: [16, 4, 0], Head: [30, 6, 0],
          UpperArmR: [-76, 0, -10], LowerArmR: [-20, 0, 0], HandR: [-10, 0, -8],
          UpperArmL: [-46, 0, 14], LowerArmL: [-40, 0, 0], HandL: [14, 0, 6],
          UpperLegL: [-52, 0, 4], LowerLegL: [62, 0, 0], FootL: [18, 0, 0],
          UpperLegR: [-78, 0, -6], LowerLegR: [98, 0, 0], FootR: [44, 0, 0],
        },
      },
      {
        ...
        root: [-0.02, -0.45, 0.11],
        pose: {
          Chest: [25, 4, 0], Spine: [14, 2, 0], Head: [26, 4, 0],
          UpperArmR: [-62, 0, -12], LowerArmR: [-48, 0, 0], HandR: [12, 0, -6],
          UpperArmL: [-50, 0, 10], LowerArmL: [-44, 0, 0], HandL: [-8, 0, 6],
          UpperLegL: [-52, 0, 4], LowerLegL: [62, 0, 0], FootL: [18, 0, 0],
          UpperLegR: [-78, 0, -6], LowerLegR: [98, 0, 0], FootR: [44, 0, 0],
        },
      },
      { t: 1.3, ease: 'out', pose: { ...RELAXED_ARMS } },
    ],
  },
