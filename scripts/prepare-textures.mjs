 ...
 *   ground (forest floor)  <- forest floor     (assets-source/forest-floor.jpg)
...
// Ground: the forest-floor sheet is the forest floor itself.
await preparePbr(await resolveSource('forest-floor'), 'forest-floor', { strength: 2.6 });
// Leaf litter is kept as an optional scatter/detail sheet.
...
console.log('Prepared the world environment set: forest-floor ground, mossy bark, earth path, rock, oak foliage.');
